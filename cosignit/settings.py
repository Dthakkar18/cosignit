"""
Django settings for cosignit project.
...
SECRET_KEY = 'django-insecure-kq0jcda2!ab5p5+&uf6pq!yutrvhrleo)cdy6(4(h$(0g%jfls'
...
WSGI_APPLICATION = 'cosignit.wsgi.application'
